...
<h1 class="block" id="code">My cool header with ID</h1>
...
To put a *indented style* code block within a list item, the code block needs to be indented twice ¡X 8 spaces or two tabs:
